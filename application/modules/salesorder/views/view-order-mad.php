...
<tbody>
<?php
   $orderhdrquert=$this->db->query("select * from tbl_order_hdr_mad where order_id_mad='$ID'");
...
<?php 
	...
	$orderdtlquert=$this->db->query("select * from tbl_order_dtl_mad where order_id_mad='$ID'");
