...
?>
<form id="f1" name="f1" method="POST" action="insertorderreg" onSubmit="return checkKeyPressed(a)">
<!-- Main content -->
...
<a href="manageorderReg"><input class="btn btn-secondary btn-sm" type="button" value="Cancel"></a>
</div>
</ol>
<?php
