...
<tr class="gradeA">
	...
	<td><input type="text" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));"  name="" id="qty<?php echo $j; ?>" tabindex="1" class="form-control" onkeyup="qtyenter(this.id,this);entertest();" value="" /></td>
