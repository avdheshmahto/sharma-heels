...
<td><?php if($fetch_list_orderdtl->cancel_status=='Cancel'){ ?>
<button class="btn btn-sm btn-secondary" type="button" data-toggle="modal" data-backdrop='static' data-keyboard='false'><i class="icon-cancel"></i></button>
<?php } ?></td>
</tr>
<?php
...
<tr>
    ...
    <td><b><?php echo $sumqty; ?></b></td><td colspan="2">&nbsp;</td>
</tr>
</table>
</div>
</div>
