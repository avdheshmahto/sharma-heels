...
<div class="col-sm-4"> 
<input type="tel" minlength="10" maxlength="10" id="mobile" name="mobile" title="10 digit mobile number"  value="" class="form-control" >
</div> 
</div>
<div class="form-group"> 
...
<div class="col-sm-4" id="regid"> 
 <input type="text" maxlength="10"  pattern="[0-9]{10}" title="Enter your 10 phone number" name="phone" id="phone" value="<?php echo $branchFetch->phone; ?>" class="form-control">
</div> 
</div>
...
<div class="col-sm-4" id="regid"> 
<div id="dataiddiv">
<input type="text" name="contact_code" id="contact_code" value="<?php echo $var; ?>" readonly=""  class="form-control">
</div>
</div> 
</div>
