...
<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
	...
	<a class="dt-button buttons-pdf buttons-html5" tabindex="0" aria-controls="DataTables_Table_0"><span>PDF</span></a>
	    	<a class="dt-button buttons-collection buttons-colvis newpayment" href="<?=base_url("GstPayment/gst_payment_Nat_edit");?>"><span>New Payment</span></a>
...
<div class="dataTables_length" id="DataTables_Table_0_length">
            <label>Show
            <select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" id="entries" url="<?=base_url('GstPayment/manage_gst_payment');?>" class="form-control input-sm">
