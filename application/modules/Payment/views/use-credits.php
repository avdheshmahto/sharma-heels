...
<div class="main-content">
	<a class="page-title" style="padding: 0 0 0 440px;font-size: 20px;">USE CREDITS</a>
			<div class="row">
				<div class="col-lg-12">
...
<div class="dataTables_length" id="DataTables_Table_0_length">
            <label>Show
            <select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" id="entries" url="<?=base_url('/Payment/use_credits');?>" class="form-control input-sm">
...
$("#excess_amount").validate({
    ...
    rules: {
      ...
      submitHandler: function(e) {
        ur = "<?php echo base_url('Payment/use_credits_invoice_entry');?>";
            $.ajax({
                type : "POST",
                url  :  ur,
