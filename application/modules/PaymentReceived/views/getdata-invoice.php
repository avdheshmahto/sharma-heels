...
$this->load->view("header.php");
 ...
 $total_bill=0;
 $queryy1="select * from tbl_invoice_payment where status='invoice' and contact_id='$contactid' and comp_id = '".$this->session->userdata('comp_id')."'";
...
$queryy123="select * from tbl_invoice_payment where status='PaymentReceived' and contact_id='$contactid' and comp_id = '".$this->session->userdata('comp_id')."'";
...
$receive_bill_amount=$receive_bill_amount+$line123->receive_billing_mount;
 ...
 ?>
 <form method="post" action="insert_payment" id="click">
