...
?>
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li><a class="btn btn-success" href="<?=base_url();?>StockRefillNew/manageStockNat">Manage Stock</a></li> 
			
		</ol>
		<ol class="breadcrumb breadcrumb-2"> 
				<li><a href="<?=base_url();?>master/Item/dashboar"><i class="fa fa-home"></i>Dashboard</a></li> 
				<li class="active"><strong><a href="#">Import Stock</a></strong></li> 
			</ol>
		<?php }?>
...
<div class="panel-heading clearfix">
		<h4 class="panel-title"><strong>Import Stock</strong></h4>
<ul class="panel-tool-options"> 
<li><a data-rel="reload" href="#"><i class="icon-arrows-ccw"></i></a></li>
</ul>
</div>
<div class="panel-body">
<form action="import_insert_stocknat" method="post" enctype="multipart/form-data">
...
<a href="" onclick="popupclose(this.value)"  title="Cancel" class="btn btn-blue"> Cancel</a>
		...
		<input type="submit" class="btn btn-primary" value="Save">
       <a href="<?=base_url();?>StockRefillNew/manageStockNat" class="btn btn-blue">Cancel</a>
