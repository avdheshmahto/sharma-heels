...
$pricedata=$this->input->post('new_price')[$i];

$this->db->query("insert into tbl_contact_product_price_mapping_log set price='$pricedata', price_mapping_id='$id', maker_date='$authordate'");

$this->software_log_insert($id,$custid,$total,'Price mapping added');	
...
public function updateprice(){
		...
		if($price!=''){
				...
				$this->db->query("insert into tbl_contact_product_price_mapping_log set price='$price', price_mapping_id='$id', maker_date='$authordate'");	
