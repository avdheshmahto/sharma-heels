...
$productQprice=$this->db->query("select * from tbl_contact_m where contact_id='$custid' and module_status='$locid'");
$fetchlistPrice=$productQprice->row();

?>
		 
<th><?php echo $fetchlistPrice->first_name;?></th>
...
<input type="hidden"  name="location_name" class="form-control" value="<?php echo $fetchlistPrice->module_status;?>" />
