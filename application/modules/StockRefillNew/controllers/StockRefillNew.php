...
public function edit_qty(){
	...
	$this->db->query("INSERT INTO tbl_stock_point_history_log SET quantity='$entedsqty_log', total_qty='$totalqty_log', p_logid='$updateid', author_date='$authordate', maker_date='$todaydate', mode_status='update'");
...
public function insertqty(){
		...
		$selectQueryser = "select * from tbl_product_serial where product_id='$pid' and location_id='$location_id' and category='$catid' and stock_point='$stockpname'";
		...
		if($numser>0){
			...
			$this->db->query("update tbl_product_serial set size='$sizeallvals',quantity='$totalq',location_id='$location_id',total_qty=total_qty+'$total_qty_values' where product_id='$pid' and location_id='$location_id' and category='$catid' and stock_point='$stockpname'");
		...
		if($pid!=''){
		 ...
		 $updatehistoryid = $this->db->insert_id();
			 ...
			 $this->db->query("INSERT INTO tbl_stock_point_history_log SET quantity='$qtyidval', total_qty='$total_qvalue', p_logid='$updatehistoryid', author_date='$mdate', maker_date='$todaydate', mode_status='Insert'");
