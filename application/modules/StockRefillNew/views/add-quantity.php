...
<a class="page-title" style="padding: 0 0 0 500px;font-size: 20px;">ADD STOCK</a>
			<div class="row">
				<div class="col-lg-12">
...
<select name="stockpid" id="stockpid"  class="form-control ui fluid search dropdown email">
...
<!--<th><button class="btn btn-success modalEditcontact" data-a="<?php //echo $fetch_list->contact_id;?>" href='#editcontact' type="button" data-toggle="modal" data-backdrop='static' data-keyboard='false'><i class="glyphicon glyphicon-plus"></i></button></th>
-->
...
<a href="repsitembyhistory"><input class="btn btn-secondary btn-sm" type="button" value="Cancel"></a>
</div>
</tr>
</tbody>
...
function getdata()
		 ...
		 var product=product1+'^'+itement+'^'+stockpid+'^'+vendorid;
