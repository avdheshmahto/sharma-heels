...
//echo $arr->stockpid;vendorid

$queryserial=$this->db->query("select * from tbl_product_stock_log where stock_point='$arr->stockpid' and vendor_id='$vendorid' and product_id='$arr->Product_id'");
