...
<!--=============================================================================================================
-->
<div style="width:100%; background:#dddddd; padding-left:0px; color:#000000;" id="m">
...
<tr><caption><center>OLD ITEMS</center></caption></tr>
<?php
$i=1;
...
<td style="width:11%;"><div align="center"><input type="text"  class="form-control" value="<?=$disp->amt;?>" readonly="readonly" /></div></td>
<td style="width:3%;"><div align="center"><input type="text"  class="form-control" value="<?=$disp->gst;?>" readonly="true"/></div></td>
...
<button class="btn btn-default" onclick="editInvval('<?php echo $prodQuery->prodcatg_name;?>','<?=$disp->qty;?>','<?=$disp->rate;?>','<?=$disp->gstp;?>','<?=$disp->amt;?>','<?=$disp->gst;?>')" type="button" data-toggle="modal" data-backdrop='static' data-keyboard='false'><i class="icon-trash"></i></button>
</td>
</tr>
<?php $i++;} ?>
...
if (cnf== true)
 ...
 var gt=Number(grandtotals)-Number(np);
