...
<tr> 
<th colspan="4">&nbsp;</th>
<th style="text-align:right;">Sub GST Amount</th>
<th>
<input type="text" class="form-control" name="total" id="total" style="text-align:center; border:none; background:#FFFFFF;" readonly="true"  value="<?=$editResult->total_billamt;?>"/></th>
<th>&nbsp;</th>
</tr>
