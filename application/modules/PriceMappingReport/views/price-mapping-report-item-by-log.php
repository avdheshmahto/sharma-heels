...
<a class="page-title" style="padding: 0 0 0 425px;font-size: 20px;">ALL PRICE MAPPING HISTORY&nbsp;</a>
<div class="row">
<div class="col-lg-12">
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="dataTables_length" id="DataTables_Table_0_length">
				<label>Show
				<select name="DataTables_Table_0_length" aria-controls="DataTables_Table_0" id="entries" url="<?=base_url('PriceMappingReport/mappingReportlog');?>" class="form-control input-sm">
