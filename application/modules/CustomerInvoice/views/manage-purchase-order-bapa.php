...
<?php  
$i=1;
$sqlorder=$this->db->query("select * from tbl_order_hdr where store_id='7' ORDER BY order_id DESC");
...
<!--
<button class="btn btn-default modalEditcontact" href="#editcontact" type="button" data-toggle="modal" data-backdrop="static" data-keyboard="false" onclick="updateInvoice('<?php echo $fetch_list->order_id;?>')"><i class="icon-pencil"></i></button>		-->	
...
<form class="form-horizontal"  id="f1" name="f1" role="form" method="post" action="invoiceUpdateFunss" enctype="multipart/form-data">			
