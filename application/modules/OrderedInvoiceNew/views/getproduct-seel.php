...
<input type="text" id="ty<?php echo $id;?>"  class="prds" value="<?php echo $arr->productname;?>" name="<?php echo $id;?>"
 onFocus="abc(this.value,'<?php echo $sizedata; ?>',this.id,'<?php echo $qtyrr; ?>','<?php echo $orderedqtyinstock; ?>','<?php echo $categoryname; ?>','<?php echo $categoryid; ?>','<?php echo $arr->Product_id_seel;?>','<?php echo $protypefetch->keyvalue; ?>','<?php echo $itemprice; ?>')"
 onClick="abc(this.value,'<?php echo $sizedata; ?>',this.id,'<?php echo $qtyrr; ?>','<?php echo $orderedqtyinstock; ?>','<?php echo $categoryname; ?>','<?php echo $categoryid; ?>','<?php echo $arr->Product_id_seel;?>','<?php echo $protypefetch->keyvalue; ?>','<?php echo $itemprice; ?>')" tabindex="-1"  readonly >
