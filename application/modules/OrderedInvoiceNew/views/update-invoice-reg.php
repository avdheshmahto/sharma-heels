...
<tbody>
<?php
   $orderhdrquert=$this->db->query("select * from tbl_order_hdr_reg where order_id_reg='$ID'");
...
<?php 
				$rowi=1;
	$orderdtlquert=$this->db->query("select * from tbl_order_dtl_reg where order_id_reg='$ID'");
