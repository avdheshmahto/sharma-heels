...
<th>
<a href="#"><i class="btn btn-sm glyphicon glyphicon-zoom-in" data-toggle="modal" data-target="#modal-<?php echo $i;?>"></i></a>&nbsp;&nbsp;&nbsp;<a href="#"><i  class="glyphicon glyphicon-pencil"  data-toggle="modal" data-target="#modal-<?php echo $i;?>"></i>
<?php
$pri_col='contact_id';
