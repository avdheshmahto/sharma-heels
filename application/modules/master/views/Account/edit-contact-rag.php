...
<input type="text" name="first_name" id="first_name" value="<?php echo $branchFetch->first_name; ?>" class="form-control" >
</div> 
...
<select name="maingroupname" class="form-control"  id="contact_id_copy5">
<?php
...
<div class="col-sm-4" id="regid"> 
<input type="text" name="tin_no"   placeholder="GSTIN" id="tin_no" value="<?php echo $branchFetch->tin; ?>" class="form-control">
</div> 
...
<div class="col-sm-4" id="regid"> 
<select name="add_opening_balancename" id="add_opening_balancename"  style="width:106px" class="form-control">
<option value="">--Select--</option>
...
<input type="number" style="width:160px" name="add_opening_balance" id="add_opening_balance" value="<?php echo $branchFetch->add_opening_balance; ?>" class="form-control">
</div> 
</div>
<div class="form-group" style="display:none"> 
...
<div class="col-sm-4" id="regid"> 
<textarea class="form-control" name="address1" id="address1"><?php echo $branchFetch->address1; ?> </textarea>
</div>
<label class="col-sm-2 control-label">Address2:</label> 
<div class="col-sm-4" id="regid"> 
<textarea class="form-control" name="address3" id="address3"><?php echo $branchFetch->address3; ?> </textarea>
</div> 
</div>
<div class="form-group"> 
<label class="col-sm-2 control-label">Note:</label> 
<div class="col-sm-4" id="regid"> 
<textarea  name="note" id="note" class="form-control"><?php echo $branchFetch->note; ?></textarea>
</div>  
</div>
</div>
